...
这只是货架的第一层。**完整清单在 [GAMES.md](GAMES.md)**——六十多部，按"它给你什么"分组：把当年还给你的、替你守住未知的、陪你读文本的、知识会倒着流的系列，外加几部看起来很适合、其实一句"别剧透"就够用的反例。每部一句理由，不碰任何剧情。

两份清单里都没有也没关系，直接把游戏名报给它，它会自己判断有没有当年可回。
